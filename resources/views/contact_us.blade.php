...
@section('content')
    <div class="mt-16">
        <h2 class="mb-4 text-4xl font-extrabold tracking-tight text-center text-gray-900 font-car">Contact
            Us</h2>
        <p class="mb-8 font-light text-center text-gray-500 font-car lg:mb-16 dark:text-gray-400 sm:text-xl">Got an
            idea you want to share with us? a question about our services? Fill out the form below and we'll get back to you
        </p>
    </div>
    <div class="flex md:flex-row flex-col justify-between max-w-screen-xl md:px-16 px-8 mx-auto gap-12 ">
        ...
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">Ishema carWash</p>
                <p class="text-sm font-light text-gray-700 font-car">Location: Kigali, Rwanda</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Kigali city</p>
                <p class="text-sm font-light text-gray-700 font-car">Postal code:Po. Box 416 Kigali</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="font-car text-pr-400 ">+250788440463</p>
            </div>
