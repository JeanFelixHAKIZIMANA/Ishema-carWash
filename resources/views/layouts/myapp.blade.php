            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        <div>
                            <h2 class="mb-6 text-sm font-semibold  uppercase text-white">Reach out</h2>
                            <ul class=" text-gray-400">
                                <li class="mb-4">
                                    <a href="#" target='_blank'="hover:underline">Talk to us</a>
                                </li>
                                <li>
                                    <a href="#" target='_blank'
                                        class="hover:underline">Know us</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2022 <a
                            href="#" target='_blank'
                            class="hover:underline">Ishema carWash™ @2024</a>. All Rights Reserved.
                    </span>
